  ...
  export default function Service() {
    ...
    return (
      <div className="min-h-screen flex justify-center items-center ">
        ...
        <div ref={scrollRef} className="mx-[5rem] py-16 w-full">
          <div className="flex gap-[2rem] px-10 justify-center">
            {services.map((service, index) => (
              ...
              >
                ...
                <div
                  className="absolute top-0 left-0 w-full h-full overflow-hidden rounded-none transition-all duration-700 ease-out scale-0 group-hover:scale-100 z-10"
                >
                  <img
                    src={service.img}
                    alt={service.title}
